...
export default function AskYearOfCompletionForm(
  { error, step, register }:
    { error: string | undefined, step: { id: string, label: string, description?: string, section: string }, register: UseFormRegister<IMemberFormSchema> }
) {
