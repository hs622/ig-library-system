    ...
    <Field data-invalid={!!error} className="gap-4">
      ...
      <InputGroup
        className={cn(
          ...
          // "border-none ring-0 outline-hidden shadow-none",
      ...
      >
        <InputGroupAddon className="text-2xl sm:text-3xl text-primary">+92</InputGroupAddon>
        <InputGroupInput
          id={step.id}
          type="text"
          autoFocus
          ...
          className={cn(
            ...
            "focus-visible:border-none! focus-visible:ring-0! focus-visible:outline-hidden! focus-visible:ring-offset-0! focus-visible:shadow-none",
            "aria-invalid:ring-0 aria-invalid:ring-offset-0 aria-invalid:shadow-none"
